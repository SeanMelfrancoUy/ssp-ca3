...
router.get('/get/html', function(req, res) {
    ...
    let xml = fs.readFileSync('SeansMusicShop.xml', 'utf8'),
        xsl = fs.readFileSync('SeansMusicShop.xsl', 'utf8');
...
router.post('/post/json', function (req, res) {
    ...
    function appendJSON(obj) {
        ...
        XMLtoJSON('SeansMusicShop.xml', function (err, result) {
            if (err) throw (err);
            ...
            JSONtoXML('SeansMusicShop.xml', result, function(err){
